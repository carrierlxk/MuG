...
class ResizeandPad_1(object):
	...
	def __call__(self, pair_0, pair_1):
		...
		Resize and Pad
		"""
		pair_0 = cv2.resize(pair_0, (self.size,self.size), self.interpolation)
		pair_1 = cv2.resize(pair_1, (self.size,self.size), self.interpolation)
